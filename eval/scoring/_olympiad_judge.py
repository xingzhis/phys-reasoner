"""Vendored AutoScoringJudge from OpenBMB/OlympiadBench.

Source: https://github.com/OpenBMB/OlympiadBench/blob/main/eval/auto_scoring_judge.py
Commit: main branch as of 2026-04-19.

Kept verbatim (minus the __main__ demo) to preserve official scoring semantics.
Do not edit. The thin wrapper that adapts our rollouts.parquet to this judge
lives in olympiad_official.py.
"""
# ruff: noqa
import re
import math
